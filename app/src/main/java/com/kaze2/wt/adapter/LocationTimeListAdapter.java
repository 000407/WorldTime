...
public class LocationTimeListAdapter extends RecyclerView.Adapter<LocationTimeListAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public LocationTimeListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
